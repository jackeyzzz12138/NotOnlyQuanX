...
// modified from https://github.com/yyhhyyyyyy/selfproxy/blob/main/Mihomo/Extension_Script/script.js
// Much thanks to @yyhhyyyyyy
...
function overwriteProxyGroups(params) {
    ...
    const autoProxyGroupRegexs = [
        ...
        {
            name: "低倍率 - 自动选择",
            regex: new RegExp(`^(?=.*(0\\.\\d+x|1x|1\\.\\d*x|2x|0\\.[1-9]倍|1倍|1\\.[0-9]倍|2倍))(?!.*${excludeTerms}).*$`, "i")
        }
    ];
    ...
    const groups = [
        ...
        },
        {
            name: "CDN",
            type: "select",
            proxies: ["低倍率 - 自动选择", "🎯 节点选择", "HK - 自动选择", "JP - 自动选择", "KR - 自动选择", "SG - 自动选择", "US - 自动选择", "UK - 自动选择", "FR - 自动选择", "DE - 自动选择", "TW - 自动选择", "其它 - 自动选择"],
            // "include-all": true,
        ...
        },
        {
            ...
            proxies: ["🎯 节点选择", "低倍率 - 自动选择", "HK - 自动选择", "JP - 自动选择", "KR - 自动选择", "SG - 自动选择", "US - 自动选择", "UK - 自动选择", "FR - 自动选择", "DE - 自动选择", "TW - 自动选择", "其它 - 自动选择"],
            // "include-all": true,
            icon: "https://raw.githubusercontent.com/Orz-3/mini/master/Color/Thunder.png"
        }
    ];
